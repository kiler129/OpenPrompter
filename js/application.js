var Prompter = function () {
    ...
    this.fileLoader = new FileLoader(this.settingsStorage, this.loadText);
...
Prompter.prototype.loadText = function (text) {
    Prompter.settings.text = text;
    Prompter.textarea.loadText(Prompter.settings.text);
